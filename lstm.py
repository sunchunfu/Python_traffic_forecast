...
class LSTM(nn.Module):
    def __init__(self, input_size=1, hidden_layer_size=32, output_size=1,num_layers=num_layers):
        super().__init__()
...
plt.plot(pred10_index, pred10,label='未来10天lstm预测')
plt.legend()
plt.savefig('lstm日交通量.png',dpi=300)
plt.cla()
plt.plot(loss_list)
plt.savefig('lstm日交通量loss.png', dpi=300)
